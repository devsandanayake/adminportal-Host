...
const LocalForeignList = () => {
  ...
  const records = [
    { id: 1, name: "LOCAL", code: "LOCAL", version: 1, is_active: true, status: "Active" },
    { id: 2, name: "FOREIGN", code: "FOREIGN", version: 1, is_active: true, status: "Active" },
  ];
  ...
  return (
    <div className="local-foreign-list">
      <div className="card">
        <div className="card-header">
          <div className="d-flex align-items-center">
            <h1 className="flex-1">Local/Foreign List</h1>
      ...
      {showPopup && (
        <div className="popup">
          <div className="popup-content">
            <h1>Create Form <span className="badge bg-primary">Local/Foreign</span></h1>
            <br />
...
export default LocalForeignList;

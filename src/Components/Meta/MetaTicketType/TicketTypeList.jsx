...
const TicketList = () => {
  ...
  const tickets = [
    { id: 1, name: "Entrance Ticket", code: "DST_ENTRANCE_TICKET", version: 1, is_active: true, status: "Active" },
    { id: 2, name: "Activity Ticket", code: "DST_ACTIVITY_TICKET", version: 1, is_active: true, status: "Active" },
  ];
      ...
      <div className="card">
        <div className="card-header">
          <div className="d-flex align-items-center">
            <h1 className="flex-1">Ticket List</h1>
      ...
      {showPopup && (
        <div className="popup">
          <div className="popup-content">
            <h1>Create Form <span className="badge bg-primary">Ticket</span></h1>
            <br />

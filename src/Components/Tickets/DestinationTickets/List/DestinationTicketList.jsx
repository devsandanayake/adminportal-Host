...
import $ from 'jquery';
import {FETCH_DESTINATION_LIST} from "../../../../constants";
import 'datatables.net-dt/css/dataTables.dataTables.css';

class DestinationTicketList extends Component {
                ...
                "dataSrc": function (json) {
                    ...
                    for(let a in data){
                        return_data.push({
                            ...
                            'action':`<button title="destination configuration" data-uuid="${data[a]['uuid']}" class="dev-cog rt-device-remove device-cog ml-2"><i class="bi bi-gear-wide-connected"></i></button>
                                        <button title="destination visibility" data-uuid="${data[a]['uuid']}" class="dev-cog rt-device-remove device-cog ml-2"><i class="bi bi-eye"></i></button>`
                        })
                    }
                    return return_data;
                },
    ...
    render() {
        return (
            <div className={`destination-ticket-list p-1 w-100`}>
                <div className="pagetitle">
                    <h1>Destination Ticket List</h1>
                    <nav>
                        <ol className="breadcrumb">
                            <li className="breadcrumb-item"><a href="#">Home</a></li>
                            <li className="breadcrumb-item active">Tickets</li>
                            <li className="breadcrumb-item active">Destination Tickets</li>
                        </ol>
                    </nav>
                </div>
                    ...
                    <div className="card">
                        <div className={`card-header`}>
                            <div className={`d-flex align-items-center`}>
                                <h1 className={`flex-1`}>Registered Destination Tickets</h1>
                                <a href={'/tickets/destination-tickets/new-registration'} className={`btn btn-sm btn-primary`}>Add New Destination Ticket</a>
                            </div>
                        </div>
...
export default DestinationTicketList;
...
class TicketPricingComponent extends Component {
    ...
    render() {
        return <div className={`border dst-images p-3 mb-3`}>
            <div className={`row`}>
                <div className={`col-3`}>
                    <div className="form-group mb-0">
                        <label className={`mb-1`} htmlFor="region2">Currency</label>
                        <br/>
                ...
                <div className={`col-3`}>
                    <div className="form-group mb-0">
                        <label htmlFor="region2">Base Price</label>
                ...
                <div className={`col-2`}>
                    <div className="form-group mb-0">
                        <label htmlFor="region2">Tax (Percentage)</label>
                        <input type={`number`} required name={`name`} value={this.state.name}
                               onChange={this.handleInputChange}
                               className="form-control f-sm  mt-1 region-select r-name"/>
                    </div>
                ...
                <div className={`col-2`}>
                    <div className="form-group mb-0">
                        <label htmlFor="region2">Discount Mode</label>
                        <input type={`number`} required name={`name`} value={this.state.name}
                               onChange={this.handleInputChange}
                               className="form-control f-sm  mt-1 region-select r-name"/>
                    </div>
                ...
                <div className={`col-2`}>
                    <div className="form-group mb-0">
                        <label htmlFor="region2">Discount</label>
                        <input type={`number`} required name={`name`} value={this.state.name}
                               onChange={this.handleInputChange}
                               className="form-control f-sm  mt-1 region-select r-name"/>
                    </div>
            ...
            <div className={`row mt-2`}>
                <div className={`col-3`}>
                    <div className="form-group mb-0">
                        <label htmlFor="region2">Final Price</label>
                        <input type={`number`} required name={`name`} value={this.state.name}
                               onChange={this.handleInputChange}
                               className="form-control f-sm  mt-1 region-select r-name"/>
                    </div>
                ...
                <div className={`col-3`}>
                    <div className="form-group mb-0">
                        <label htmlFor="region2">special Price</label>
                        <input type={`number`} required name={`name`} value={this.state.name}
                               onChange={this.handleInputChange}
                               className="form-control f-sm  mt-1 region-select r-name"/>
                    </div>
...
export default TicketPricingComponent
...
class TicketSessionComponent extends Component {
            ...
            <div className={`row`}>
                <div className={`col-3`}>
                    <div className="form-group mb-0">
                        ...
                        <input type={`text`} required name={`name`} value={this.state.name}
                ...
                <div className={`col-2`}>
                    <div className="form-group mb-0">
                        <label htmlFor="region2">Day</label>
                ...
                <div className={`col-2`}>
                    <div className="form-group mb-0">
                        <label htmlFor="region2">Day Start From</label>
                        <input type={`time`} required name={`name`} value={this.state.name}
                               onChange={this.handleInputChange}
                               className="form-control f-sm  mt-1 region-select r-name"/>
                    </div>
                </div>
                <div className={`col-2`}>
                    <div className="form-group mb-0">
                        <label htmlFor="region2">Day End To</label>
                        <input type={`time`} required name={`name`} value={this.state.name}
                               onChange={this.handleInputChange}
                               className="form-control f-sm  mt-1 region-select r-name"/>
                    </div>
...
export default TicketSessionComponent